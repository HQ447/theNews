    ...
    return (
        <div className='flex flex-col  py-4 gap-4 px-20 shadow-[0_4px_6px_rgba(0,0,0,0.1)] mb-6' >
            ...
            <div className='flex justify-center flex-row-reverse items-center gap-4 '>
                ...
                <NavLink to="/" onClick={() => setActive("l")} className={` ${isActive == "l" ? "text-red-600 font-bold" : "text-gray-500"} font-urdu-kasheeda hover:bg-amber-600 px-3 py-1 rounded-md  hover:text-white transition-all duration-300  text-2xl `}>تازہ ترین</NavLink>
                ...
                <NavLink to="/login" className={"font-urdu bg-indigo-600 text-white px-3 py-1 rounded-md  text-2xl "}>لاگ ان</NavLink>
            </div>
        </div>
    )
}
